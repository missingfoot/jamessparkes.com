...
import clipcutCover from '../../assets/images/clipcut-cover.png';

<Image src={clipcutCover} alt="ClipCut's cut screen, with a video loaded and two cuts marked on the timeline" loading="lazy" />
