...
export function SocialLinks() {
    return `
        ...
        <div class="mt-6 flex flex-wrap gap-4">
            ...
            <!-- Download CV -->
            <a href="https://jamessparkes.s3.eu-west-1.amazonaws.com/James_Sparkes_CV.pdf" target="_blank" rel="noopener noreferrer" class="group relative text-gray-700 dark:text-white hover:text-gray-900 dark:hover:text-gray-200 underline transition-all duration-300 cursor-pointer">
