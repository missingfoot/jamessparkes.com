export function PortfolioDetailModal() {
    return `
        <div id="portfolioDetailModal" class="fixed inset-0 z-[1001] hidden">
            ...
            <div id="portfolioModalContent" class="absolute bottom-0 sm:bottom-8 sm:left-1/2 sm:-translate-x-1/2 bg-surface-light dark:bg-surface-dark rounded-t-xl sm:rounded-xl transform translate-y-full sm:translate-y-full transition-transform duration-300 h-[90vh] sm:h-[calc(100vh-4rem)] sm:max-w-[720px] w-full flex flex-col">
                ...
                <!-- Portfolio content -->
                <div id="portfolioContent" class="flex-grow overflow-y-auto p-4 sm:py-8 sm:px-24 text-gray-800 dark:text-gray-200">
